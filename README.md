...
### [Encoder Archaeology](./encoder-archaeology/)
Comparative study of transformer vs non-transformer encoder architectures for dense retrieval, focused on the latency-accuracy frontier under production constraints.
